      ...
      <div class="panel graph" style="display: block;"> \
        <div class="js-temp-notice alert alert-block"> \
          <h3 class="alert-heading">Ol\u00E1!</h3> \
	  	  <p>Nenhum gr\u00E1fico est\u00E1 sendo exibido porque ainda n\u00E3o sabemos quais vari\u00E1veis voc\u00EA gostaria de visualizar.</p> \
	  	  <p>Por favor, informe <strong>no menu \u00E0 direita</strong> quais as vari\u00E1veis de cada eixo, e assim o gr\u00E1fico ser\u00E1 tra\u00E7ado automaticamente.</p> \
        </div> \
      </div> \
    </div> \
',
    ...
    <form class="form-stacked"> \
      <div class="clearfix"> \
        ...
        <div class="input editor-type"> \
          <select> \
          <option value="lines-and-points">Linhas e Pontos</option> \
          <option value="lines">Linhas</option> \
          <option value="points">Pontos</option> \
          <option value="bars">Barras Horizontais</option> \
      ...
      <div class="editor-buttons"> \
        <button class="btn editor-add">Adicionar S\u00E9rie</button> \
      </div> \
      <div class="editor-buttons editor-submit" comment="hidden temporarily" style="display: none;"> \
        <button class="editor-save">Salvar</button> \
...
my.Pager = Backbone.View.extend({
  ...
  template: ' \
    <div class="pagination"> \
      <ul> \
        <li class="prev action-pagination-update"><a href="">&laquo; Anterior</a></li> \
        ...
        <li class="next action-pagination-update"><a href="">Pr\u00F3xima &raquo;</a></li> \
      </ul> \
    </div> \
  ',
