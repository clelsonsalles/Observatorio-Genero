...
var Buckets = Backbone.View.extend({
    ...
    tags: [],
     ...
     tags_template: function() {
            ...
            var t = "<div class='bucket_items'><ul>" +
                "<li><a href='#' class='add_bucket i18n button' title='Ao criar uma nova etiqueta, você deve selecionar também as células a serem etiquetadas.'> </a></li>";
    ...
    add_button: function() {
        var $stats_button = 
            $('<a href="#buckets" class="buckets button disabled_toolbar i18n" title="Etiquetas"></a>')
    ...
    add_bucket: function(event) {
        ...
        $("<li><input id='new_bucket' type='text' class='new_bucket'/></li><li>" 
            + "<a href='#save_bucket' class='i18n save sprite button new_bucket' title='Salvar Etiqueta'></a></li>")
    ...
    save_bucket: function() {
        ...
        if($cells.size() < 1) {
            alert("Você deve selecionar pelo menos uma célula para salvar a etiqueta!");
            return;
        }
        var positions = "";
