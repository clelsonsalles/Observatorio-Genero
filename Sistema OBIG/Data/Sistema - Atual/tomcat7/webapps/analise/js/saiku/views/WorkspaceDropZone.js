        ...
        $.contextMenu({
            ...
            ignoreRightClick: true,
             build: function($trigger, e) {
                ...
                var citems = {
                        "filter" : {name: "Filtrar", items: 
                         { 
                                "customfilter": {name: "Filtro Customizado..." },
                                "clearfilter": {name: "Limpar Filtro" }
                         }},
                        "limit" : {name: "Limitar", items: 
                        {
                                "TopCount###SEPARATOR###10": {name: "10 Maiores" },
                                "BottomCount###SEPARATOR###10": {name: "10 Menores" },
                                "TopCountQuick" : { name: "10 Maiores por...", items: addFun(items, "TopCount") },
                                "BottomCountQuick" : { name: "10 Menores por...", items: addFun(items, "BottomCount") },
                                "customtop" : {name: "Limite Customizado..." },
                                "clearlimit" : {name: "Limpar Limite"}
                         }},
                        "sort" : {name: "Ordenar", items:
                        {
                            "ASCQuick": {name: "Ascendente" , items: addFun(items, "ASC") },
                            "DESCQuick": {name: "Descendente", items: addFun(items, "DESC")},
                            "BASCQuick": {name: "Ascendente (Ignorar Hierarquia)", items: addFun(items, "BASC")},
                            "BDESCQuick": {name: "Descendente (Ignorar Hierarquia)", items: addFun(items, "BDESC") },
                            "customsort" : { name: "Customizado..." },
                            "clearsort" : {name: "Limpar Ordenação" }
                        }}
                };
