...
var Table = Backbone.View.extend({
    ...
    $.contextMenu({
        ...
        ignoreRightClick: true,
         build: function($trigger, e) {
            ...
            var citems = {
                    "name" : {name: "<b style='color: blue;'>" + member + "</b>", disabled: false },
                    "sep1": "---------",
                    "keeponly": {name: "Manter apenas esta fatia", payload: keep_payload }
            };
            if (d != "Measures") {
                citems["getchildren"] = {name: "Desagregar", payload: children_payload }
                citems["fold1key"] = {
                        name: "Acrescentar o nível",
                        items: lvlitems("include-")
                    };
                citems["fold2key"] = {
                        name: "Manter apenas esta fatia e incluir o nível",
                        items: lvlitems("keep-")
                    };
                citems["fold3key"] = {
                        name: "Remover nível",
    ...
    render: function(args, block) {
        ...
        $(this.el).html('<tr><td>Montando ' + args.data.width + ' colunas e ' + args.data.height + ' linhas...</td></tr>');
    ...
    process_data: function(data) {
        ...
        // Append the table
        $(this.el).html(contents + "<br/><code>DataSEPPIR 1.0</code><br/><br/>");
        this.post_process();
    },
