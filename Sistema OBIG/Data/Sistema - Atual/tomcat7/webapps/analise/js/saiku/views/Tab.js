...
var Tab = Backbone.View.extend({
    ...
    template: function() {        
        ...
        return _.template("<a class='saikutab' href='#<%= id %>'><%= caption %></a>" +
                "<span class='close_tab sprite'>Fechar aba</span>")
            ({
                id: this.id,
    ...
    render: function() {
        ...
        $.contextMenu({
                ...
                items: {
                    "new": {name: "<span class='i18n'>Nova aba</span>"},
                    "closethis": {name: "<span class='i18n'>Fechar esta aba</span>"},
                    "closeothers": {name: "<span class='i18n'>Fechar outras</span>"}
                }
            });
