...
var Workspace = Backbone.View.extend({
    ...
    caption: function(increment) {
        ...
        return "<span class='i18n'>Nova consulta</span> (" + (Saiku.tabs.queryCount) + ")";
    },
    ...
    cancelled: function(args) {
        this.processing.html('<span class="processing_image">&nbsp;&nbsp;</span> <span class="i18n">Cancelando Pesquisa...</span>').show();
    },

    no_results: function(args) {
        this.processing.html('<span class="i18n">Sem Resultados</span>').show();
    },
