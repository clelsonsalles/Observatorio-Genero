...
var WorkspaceToolbar = Backbone.View.extend({
    ...
    swap_axis: function(event) {
        ...
        $(this.workspace.processing).html('<span class="i18n">Alternando eixos...</span>');
        this.workspace.block('Alternando eixos...');
    ...
    clicked_cell_drillthrough_export: function(event) {
        ...
        (new DrillthroughModal({
            workspace: this.workspace,
            maxrows: 10000,
            title: "Listar registros para um arquivo CSV",
            action: "export",
            position: pos,
    ...
    clicked_cell_drillthrough: function(event) {
        ...
        (new DrillthroughModal({
            workspace: this.workspace,
            maxrows: 200,
            title: "Listar Registros (Drill-Through)",
            action: "table",
